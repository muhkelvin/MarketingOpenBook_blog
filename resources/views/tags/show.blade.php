...
@section('meta_description', 'Browse articles tagged with ' . $tag->name)

@section('content')
    <div class="max-w-7xl mx-auto px-4 lg:px-8 py-12">
        <header class="mb-16 text-center">
            <h1 class="font-playfair text-4xl lg:text-5xl text-secondary mb-4">
                Tag: <span class="text-accent">{{ $tag->name }}</span>
            </h1>
            <p class="font-montserrat text-darkgray/80 text-lg">
                Exploring articles related to <span class="font-semibold text-accent">{{ $tag->name }}</span>
            </p>
        </header>
